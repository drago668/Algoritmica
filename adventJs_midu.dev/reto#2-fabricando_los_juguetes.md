...
1. Cada juguete repetido tantas veces como indique `quantity`
2. En el mismo orden en el que aparecen en la lista original
3. Ignorando los juguetes con cantidades no válidas (menores o iguales a 0, o que no sean número)
